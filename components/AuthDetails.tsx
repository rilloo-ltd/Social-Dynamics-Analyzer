        ...
        <div className="absolute top-2 right-2 sm:top-4 sm:right-4 text-right z-50">
            {displayedEmail ? (
                <div className="bg-white/80 backdrop-blur-md rounded-2xl shadow-lg border border-white/20 px-3 py-2 sm:px-4 sm:py-3 min-w-[160px] sm:min-w-[200px]">
                    ...
                    <button
                        onClick={logOut}
                        className="w-full flex items-center justify-center gap-1.5 sm:gap-2 px-3 py-1.5 sm:px-4 sm:py-2 bg-gradient-to-r from-red-500 to-pink-600 text-white rounded-xl font-medium text-xs sm:text-sm hover:from-red-600 hover:to-pink-700 transition-all duration-200 shadow-md hover:shadow-lg transform hover:-translate-y-0.5 cursor-pointer"
                    >
