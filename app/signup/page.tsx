...
export default function SignUpPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-pink-500 via-purple-600 to-indigo-600 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative max-w-md w-full">
        ...
        <div className="text-center mb-8 animate-fadeIn">
          ...
          <h1 className="text-4xl font-black text-white mb-2" dir="rtl">הצטרפו אלינו!</h1>
          <p className="text-white/80 text-sm" dir="rtl">צרו חשבון חדש והתחילו לנתח את השיחות שלכם</p>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8 backdrop-blur-sm border border-white/20 animate-slideUp">
          ...
          >
            ...
            <span>{loading ? 'נרשם...' : 'הירשם עם Google'}</span>
          </button>
          ...
          <form onSubmit={handleSignUp} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  disabled={loading}
                  required
                  className="w-full pr-11 pl-4 py-3 border-2 border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent disabled:opacity-50 disabled:bg-slate-50 transition-all"
                  dir="ltr"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 mt-1 text-right" dir="rtl">לפחות 6 תווים</p>
            </div>
            ...
            <button 
              type="submit" 
              disabled={loading}
              className="w-full bg-gradient-to-r from-pink-500 to-purple-600 text-white py-3.5 rounded-xl hover:from-pink-600 hover:to-purple-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer font-bold shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 mt-6 flex items-center justify-center gap-2"
            >
              <UserPlus className="w-5 h-5" />
              <span>{loading ? 'נרשם...' : 'הירשם עכשיו'}</span>
            </button>
          </form>
